...
import { useRouter } from "next/navigation";
 ...
 const page = () => {
  ...
  return (
    <div>
        {isMailTrie?<SignUp userDetails = {userDetails} setUserDetails = {setUserDetails} setIsMailTrue= {setIsMailTrue} setOtp ={setOtp}/>:
        <VerifiedOtp handleSubmitVerify= {handleSubmitVerify} otp = {otp} pinned = {pinned} setpine={setpine}/>}
    </div>
  )
}
export default page